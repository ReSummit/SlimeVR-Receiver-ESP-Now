...
// Default USB Settings (ESP32-C2 has no USB peripheral; these are for the shared
// code's product strings only — the dongle talks over UART).
...
#define USB_FW_MSC_VENDOR_ID        "ESP32-C2"     // max 8 chars
#define USB_FW_MSC_PRODUCT_ID       "Firmware MSC" // max 16 chars
#define USB_FW_MSC_PRODUCT_REVISION "1.23"         // max 4 chars
#define USB_FW_MSC_VOLUME_NAME      "C2-Firmware"  // max 11 chars
#define USB_FW_MSC_SERIAL_NUMBER    0x00000000

// Defines for Serial / HID Selection
// (C2 has no USB, so serial-only is the only option — SERIAL_USB_ONLY is set
//  for consistency; SERIAL_BAUD_RATE is required by the shared serial code.)
#define SERIAL_USB_ONLY
#define SERIAL_BAUD_RATE 921600

// TODO: verify these pins for your C2 hardware
// C2 devkit (ESP8684) onboard RGB LED is on GPIO8, boot button on GPIO9
