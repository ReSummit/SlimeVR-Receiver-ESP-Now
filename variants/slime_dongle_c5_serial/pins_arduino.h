...
#define USB_FW_MSC_VENDOR_ID        "ESP32-C5"     // max 8 chars
#define USB_FW_MSC_PRODUCT_ID       "Firmware MSC" // max 16 chars
#define USB_FW_MSC_PRODUCT_REVISION "1.23"         // max 4 chars
#define USB_FW_MSC_VOLUME_NAME      "C5-Firmware"  // max 11 chars
...
// TODO: verify these pins for your C5 hardware
// C5 devkit onboard RGB LED is on GPIO8, boot button on GPIO28
static const uint8_t LED_BUILTIN = 8;
#define BUILTIN_LED LED_BUILTIN // backward compatibility
#define LED_BUILTIN LED_BUILTIN // allow testing #ifdef LED_BUILTIN
static const bool LED_ACTIVE_LEVEL = true;

static const uint8_t USER_BUTTON = 28;
